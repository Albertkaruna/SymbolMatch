...
public class ShareAndRate : MonoBehaviour
{
	...
	string subject = "Symbol Match";
	string body = "Have you played Symbol Match? https://play.google.com/store/apps/details?id=com.hyperzeta.symbolmatchmath";
	...
	{
		#if UNITY_ANDROID
		Application.OpenURL("https://play.google.com/store/apps/details?id=com.hyperzeta.symbolmatchmath");
		#elif UNITY_IPHONE
